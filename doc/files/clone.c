// from jessfraz https://gist.github.com/jessfraz/0d581a5085172c5ee2ba
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <sched.h>
...
static int child_exec(void *stuff)
{
        ...
        // ejs todo: pid+mount demo not working
        // mount proc
        /*
        if (umount("/proc", 0) != 0) {
        ...
        */
        ...
        // sethostname
        const char * new_hostname = "navitainer";
...
int main(int argc, char **argv)
{
        ...
        int clone_flags = CLONE_NEWPID | CLONE_NEWNS | CLONE_NEWNET | CLONE_NEWUTS | CLONE_NEWIPC | CLONE_NEWUSER| SIGCHLD;
